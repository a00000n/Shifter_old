        ...
        if (mHeader != null && mChildren != null) {
            ...
            OnClickWrapper wrapper = new OnClickWrapper() {
                ...
                public void onClick(View v) {
                    CheckBox parent = (CheckBox) getWrapperParam(String.valueOf(v.getParent().getParent().hashCode() + 1));
                    parent.setChecked(!parent.isChecked());
                }
            };
            wrapper.setWrapperParam(String.valueOf(hashCode() + 1), mActiveCat);
            ...
            OnCheckedChangedWrapper wrapperChecked = new OnCheckedChangedWrapper() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    LinearLayout mLayout = (LinearLayout) getWrapperParam(String.valueOf(buttonView.getParent().getParent().hashCode()));
            ...
            wrapperChecked.setWrapperParam(String.valueOf(hashCode()), mContainer);
