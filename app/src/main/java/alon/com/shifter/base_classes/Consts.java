...
public interface Consts {
    ...
    final class Fb_Keys {
        ...
        public static final String MGR_SEC_SUBMISSION_CAP = "submission-cap";
        ...
        public static final String MGR_SEC_SHIFT_SUBMISSION_CAP = "shift-submission-cap";
    }
    ...
    final class Fb_Dirs {
        ...
        public static final String STORAGE_ARRAGNEMENT = "arragnement-file";
        public static final String STORAGE_SHIFT_HOURS = "shift-hours-file";
    }
    ...
    final class Pref_Keys {
        ...
        public static final String USR_SPEC_SETTINGS_RESTS_AND_NAMES = ">>complete_shift_info<<";
        ...
        public static final String MGR_SEC_SCHEDULE_INFO = ">>schedule_info<<";

        public static final String MGR_SEC_USER_RQS = ">>user_requests<<";
        public static final String MGR_SEC_USER_LIST = ">>user_list<<";
        public static final String MGR_SEC_SUBMISSION_CAP = ">>submission_cap_day<<";
    ...
    final class Linker_Keys {
        ...
        public static final int TYPE_GET_SUBMITED_SHIFTS = 0x044548;
        ...
        public static final int TYPE_UPLOAD_SHIFT_SUBMISSION_CAP = 0x842787;

        public static final int TYPE_UPLOAD_FILE_SHIFT_ARRGMENT = 0x0d6577;
        public static final int TYPE_UPLOAD_FILE_SHIFT_HOURS = 0x470515;
        ...
        public static final String KEY_ARRGMENT_DATE_FOR_THE_SHIFT_PULL = "shift_submission_date";

        public static final String KEY_ARRANGEMENT_OBJECT = "arragnement_object";
        public static final String KEY_ARRGMENT_DIALOG = "arrangement_dialog_object";

        public static final String KEY_SHIFT_HOURS_OBJECT = "shift_hour_object";

        public static final String KEY_SHIFT_SUBMISSION_CAP_STRING = "shift_submission_cap_string";
    }
    ...
    final class Param_Keys {
        ...
        public static final String KEY_SHIFT_HOURS_BYTE_ARRAY = "Wo9GoHQC2rHNz03T3zmE";
        public static final String KEY_ARRANGEMENT_OBJECT = "XdW8SPmh6VFGWsxksSaB";
    }
    ...
    final class Strings {
        ...
        public static final String KEY_ARRANGEMENT_OBJECT = "WuUj5ogsuAdeabWgQfKi";
        public static final String KEY_ARRANGEMENT_USER_ARRAYLIST = "m0asujwDTWizeCTYTUmi";
        ...
        public static final String VALUE_UPLOAD_SHIFT_JSON_KEY = "json_shiftrqs_value";
        public static final String VALUE_UPLOAD_SHIFT_COMMENT_JSON_KEY = "json_shiftrqs_comment_value";
        public static final String VALUE_UPLOAD_SHIFT_RQS_NEXT_SUNDAY = "json_shiftrqs_the_week_start_date";

        public static final String MGR_ARRGMENT_DEFAULT_TIME = "default";
        //Added during the pull request from the host.
        public static final String VALUE_UPLOAD_SHIFT_JSON_USER_NAME_KEY = "json_shiftrqs_the_user_requesting";
    }
    ...
    final class Ints {
        ...
        public static final int DB_ERR_HELPER_NULL = -1;
        public static final int DB_ERR_DATABASE_EXISTS = -2;
        public static final int DB_ERR_DATABASE_CLOSED = -3;
        public static final int DB_ERR_ALREADY_STARTED = -4;
        public static final int DB_INJECTION_JSON_PARSE_ERROR = -5;

        public static final int DB_RESULT_OKAY = 1;
    ...
    final class Fc_Keys {
        ...
        public static final String SUBMISSION_CAP_PULLED = "LEyNTLIimmzAfW8AeylV";
    }
    ...
    final class DialogFragment_Keys {
        ...
        public static final String TIME_PICKER_SHIFT_START = "time_picker_start_time_key";
        public static final String TIME_PICKER_SHIFT_END = "time_picker_end_time_key";
        public static final String NUMBER_FETCHER_DIALOG = "get_phone_number_dialog_key";
        public static final String WAIT_DIALOG = "please_wait_dialog_key";
        public static final String NUMBER_VERIFICATION_DIALOG = "number_verification_dialog_key";
    }
}
